#!/usr/bin/env python3
"""
Recuperation des codes promo Auchan depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/auchan.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/auchan.fr"
STORE_NAME = "Auchan"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Auchan depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-auchan)"
    }
    try:
